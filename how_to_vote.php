     	...
     	<div class="col-md-12">
     		<div class="row">
     			...
     			<div class="col-md-11"> 
                   ...
                   <!--<p>Thank you for registering our application and we are glad to see you, we will tech you how to vote is our system slowly and understandable .--><br>Here are the steps you need to follow before you can vote successfully.</p>
                   ...
                   <ol>
                    ...
                    <li>View all contestants available</li>
                   ...
                   <ol class="wow zoomIn">
                   	...
                   	<li>Do not Go Back while voting.</li>
