					...
					<div class="row text-center">
						...
						<p class="text-danger"><?php if(isset($errors['sname'])) echo $errors['sname']; ?></p>
							...
							<select class="form-control" name="department">
								...
								<option value="Information Technology">Information and Communication Technology</option>
								<option value="Automotive">Computer Science</option>
								<option value="Mechanical">Actuarial Science</option>
                                 <!--<option value="Welding">Nursing</option>-->
                                 <!--<option value="Building & Constraction">RS</option>-->
