...
<body >
	<div style="margin-top: 130px;"></div>
      <h3 class="text-center text-success"> Vote Chart</h3>
    <span>
...
<!--boy prefect-->
		...
		<div class="col-md-12 bg-primary text-center"  style="height: 70px;color: black;">
			<h3 class="" style="margin-top: -10px;">President</h3>
		</div>
     ...
     chat($row['image'],$row['firstname'],$row['surname'],$row['votes']);
  	...
  	?>
			...
			<br><br>
				<!--Girls Prefect-->
		<div class="col-md-12 bg-primary text-center"  style="height: 70px;color: black;">
			<h3 class="" style="margin-top: -10px;">Vice-President</h3>
		</div>
		<div class="container-fluid">
	<div class="row text-center py-5">
		      	<?php
     ...
     chat($row['image'],$row['firstname'],$row['surname'],$row['votes']);
  	...
  	?>
		...
		<div class="col-md-12 bg-primary text-center"  style="height: 70px;color: black;">
			<h3 class="" style="margin-top: -10px;">General Secretary</h3>
		</div>
		<div class="container-fluid">
	<div class="row text-center py-5">
		      	<?php
     ...
     chat($row['image'],$row['firstname'],$row['surname'],$row['votes']);
  	...
  	?>
		...
		<div class="col-md-12 bg-primary text-center"  style="height: 70px;color: black;">
			<h3 class="" style="margin-top: -10px;">Women's Commissioner</h3>
		</div>
		<div class="container-fluid">
	<div class="row text-center py-5">
		      	<?php
